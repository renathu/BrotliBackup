...
using BrotliBackup.FolderDialog.Interop;

namespace BrotliBackup.FolderDialog
{
    /// <summary>
    ...
    public sealed class SuperFolderBrowserDialog : CommonDialog
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="SuperFolderBrowserDialog" /> class.
        /// </summary>
        public SuperFolderBrowserDialog()
        {
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the <see cref="SuperFolderBrowserDialog" /> and optionally releases the managed resources.
        /// </summary>
        ...
        private void SetDialogProperties(Interop.IFileDialog dialog)
        {
            // Description
        ...
        private void GetResult(Interop.IFileDialog dialog)
        {
            Interop.IShellItem item;
